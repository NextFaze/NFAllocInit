...
- (NSTimeInterval)intervalToDate:(NSDate *)otherDate forUnit:(NSCalendarUnit)unit
{
    NSTimeInterval thisInterval = [self timeIntervalSince1970];
    NSTimeInterval otherInterval = [otherDate timeIntervalSince1970];
    NSTimeInterval difference = otherInterval - thisInterval;
